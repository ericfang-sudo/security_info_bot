...
Automated threat-intel pipeline: fetches TWCERT and CISA KEV daily, runs Gemini AI analysis, writes results to Google Sheets, and archives all artefacts to a dedicated git branch. For specifics, follow the documentation index below. (Loaded automatically by Claude Code, Gemini CLI, and other agents via symlinks.)
